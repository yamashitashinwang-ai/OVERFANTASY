...
import { panelHeader, weaponForgeEntries, weaponForgeCategories, selectedWeaponForgeEntry, selectedForgeMaterial, materialOptionList, forgeEffectText, forgeRequirementHtml, forgeSlotButton } from './panels-helpers.ts';
import { hasForgeIngredients } from '../domain/economy.ts';
