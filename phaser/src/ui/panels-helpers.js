...
// scenes/Game.js so the scene stays focused on lifecycle.
...
import { sellMaterial } from '../domain/economy.js';
import { gearLabel, slotName, gearModList, equippedModList } from '../domain/combat/weapon.js';
import { materialMod, forgeIngredientCount } from '../domain/economy.js';
import {
...
export function panelHeader(title, actionName) {
...
export function modSummary(mod) {
  const parts = [];
...
export function backpackItems(category) {
...
export function forgeEffectText(name) {
...
export function backpackDetailHtml(item) {
...
export function forgeSlotButton(materialName, slot) {
...
export function forgeRequirementHtml(materials = {}) {
...
export function questAutoSettlementText(q) {
...
export function questDetailCard(q, label) {
