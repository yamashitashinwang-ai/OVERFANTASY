...
//
// Decoupling: This module imports from domain services + scenes/Game.js
// re-exports. It does NOT mutate state — purely a render function.

import DATA from '../data.js';
import { state } from '../scenes/Game.js';
import { formatNumber } from '../domain/math.js';
import { t, raceLabel } from '../domain/i18n.js';
import {
  currentWeapon, refreshCombatStats, hasPathosEffect
} from '../domain/combat/weapon.js';
import { regionAt } from '../domain/world.js';
import { materialSummary } from '../domain/inventory.js';
import { questBelongsToCurrentPlayer, ownedByCurrentPlayer } from '../domain/session.js';
...
export function bindStatsEl(_el) { /* deprecated; get.statsEl resolves lazily */ }
