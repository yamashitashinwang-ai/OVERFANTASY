...
// transitions.  DOM-coupled bits (clearing log textarea, applying language to
// panel chrome) still call Game.js facades until those bits move to scenes.

import DATA from '../data.js';
import { state, runtime, logs, flyingArrows, magicEffects, initialState, initialRegions } from '../runtime/state.js';
import { bus, Events } from '../runtime/events.js';
import { uiState, isPlaying } from '../runtime/ui-state.js';
import { clonePlain, replaceObject } from './math.js';
import {
  worldOwnerId,
  currentPlayerId, currentPartyId,
  ensureOwnedRecord, ensureSessionState, makeRuntimeId
} from './session.js';
import { isValidLanguage, readLanguageSetting, currentLanguage } from './i18n.js';
import { isRemovedMapWeaponPickup } from './world.js';
import { syncResourceTotals } from './inventory.js';
import {
...
import { rebuildDisplay } from '../display/index.js';
import {
  // facades still hosted in Game.js (DOM-coupled side-effects)
  log, resetRuntimeUi, applyLanguage
} from '../scenes/Game.js';
import { renderGearPanel } from '../ui/gear.js';
import { renderMainMenu } from '../ui/menus.js';
import { htmlCache } from '../ui/cache.js';
import { get as domGet } from '../ui/dom.js';
import { installPlayerCooldowns } from '../runtime/player-cooldowns.js';
...
export function startLoadedSave(saveId) {
