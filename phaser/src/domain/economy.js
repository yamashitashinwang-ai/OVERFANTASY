...
import { isNearAction } from './npc.js';
...
export function materialMod(name, targetSlot) {
...
export function weaponForgeRecipe(gearId) {
...
export function sellMaterial(name, amount = 1) {
  const material = materialCatalog[name];
...
export function forgeMaterial(name, targetSlot) {
...
export function forgeWeapon(gearId) {
