...
import { rand, clamp, dist, choice } from './math.js';
import { currentPlayerId, ownedByCurrentPlayer } from './session.js';
import { hostileRaceDialogue } from './combat/race.js';
import { addEntity, addPickup, currentPetScene } from './world.js';
import { nearestEntity } from './combat/targeting.js';
import {
  // facades still in Game.js
  log, toast, autoSave, npcMemoryFor, npcMemoryKey, ensureNpcMemoryOwnership, loadScene
} from '../scenes/Game.js';
import { handleDeliveryTalk, activeSmallQuestFor, settleSmallQuest } from './quest.js';
import { shareMagicRumor } from './magic.js';
import { recallPets } from './inventory.js';

const { regions, sceneNames } = DATA;

export function objectEdgeDistance(o, actor = state.player) {
...
export function adjustNpcMemory(npcName, affection, devotion) {
...
export function chatWithNpc(npc, message) {
...
export function isNearAction(action, range = 2.3) {
...
import { openShopPanel } from '../ui/shop.js';
import { openForgePanel } from '../ui/forge.js';
import { openMagicPanel } from '../ui/magic.js';
import { refreshCombatStats } from './combat/weapon.js';
import { enterDungeon } from './dungeon.js';

export function useObject(obj) {
...
export function openNpcQuestPanel(npc) {
