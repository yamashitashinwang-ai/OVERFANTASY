...
//
// Pure of DOM and scene imports. Uses runtime services + domain combat helpers.

import { state } from '../runtime/state.ts';
import { rand, dist } from './math.ts';
import { ownedByCurrentPlayer } from './session.ts';
import { moveActor } from '../display/index.ts';
import { raceDamageMultiplier } from './combat/race.ts';
import { log } from '../runtime/services.ts';
import { runtime } from '../runtime/state.ts';
import { attackEntityFilter } from './combat/targeting.ts';
import { defeatEntity, damagePlayer, damagePet, petDiesIrreversibly, petById } from './combat/damage.ts';
