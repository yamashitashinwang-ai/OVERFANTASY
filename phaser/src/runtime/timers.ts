...
export function schedulePeriodic(scene: Phaser.Scene, intervalMs: number, callback: () => void) {
...
export function scheduleOnce(scene: Phaser.Scene, delayMs: number, callback: () => void) {
