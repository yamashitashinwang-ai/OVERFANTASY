...
import { PLAYER_COOLDOWN_FIELDS } from './player-cooldowns.js';
import { isPlaying } from './ui-state.js';
import { log, NS } from './log.js';
...
const violations = [];           // { t, id, message }
const livenessClocks = new Map(); // id -> seconds since condition first held
...
function recordViolation(id, message, severity = 'error') {
