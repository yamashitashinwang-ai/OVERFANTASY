...
import { W, H } from '../scenes/Game.js';
import { syncPlayerDisplay, syncEntityDisplay, syncObjectDisplay,
         syncPickupDisplay, syncPetDisplay, syncPetRemainsDisplay,
         syncHpBars, rebuildDisplay } from './world.js';
import { syncWeaponDisplay, syncArrowsDisplay, syncEffectsDisplay } from './effects.js';
import { syncHudDisplay } from './hud.js';
import { initDebugHud, syncDebugHud } from './debug-hud.js';

// Re-export the public API so callers can import everything from one place.
export { rebuildDisplay } from './world.js';
export { moveActor, syncStateFromBodies, zeroAllVelocities,
         getActorBody, teleportBody, attachCircleBody,
         rebuildPhysicsForMap } from './physics.js';
export { hexToInt, brightenColorInt } from './colors.js';
...
export function initDisplay(scene) {
  D.pScene = scene;
